...
<%@ page import="it.distributedsystems.model.dao.ProducerDAO" %>
<%@ page import="it.distributedsystems.model.dao.ProductDAO" %>
<%@ page import="it.distributedsystems.model.dao.PurchaseDAO" %>
...
<%!
	...
	String printTableRows(List<Product> products, String url) {
		StringBuffer html = new StringBuffer();
